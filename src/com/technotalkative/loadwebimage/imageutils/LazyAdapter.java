...
public class LazyAdapter extends BaseAdapter {
    ...
    public LazyAdapter(Activity a, List<Map<String, Object>>list) {
        activity = a;
        //data=d;
        this.list=list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View vi=convertView;
        if(convertView==null)
            vi = inflater.inflate(R.layout.localmsg_list, null);
...
//        int facceor=list.get(position).get("msgimg").toString().indexOf("face");
